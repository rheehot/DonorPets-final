...
public class DetailActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "shelterId : " + MyData.getShelterPosition(), Toast.LENGTH_SHORT).show();
        Intent intent = getIntent();
        storyPosition = intent.getExtras().getString("storyPosition");
        shelterPosition = MyData.getShelterPosition();

        Storydatabase = FirebaseDatabase.getInstance();
        myRefStory = Storydatabase.getReference("shelter").child(shelterPosition).child("story").child(storyPosition);
        ...
        findViewById(R.id.btn_send).setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(message)) {
                    ...
                    chatData.userName = SaveSharedPreference.getUserName(DetailActivity2.this);
    ...
    public void onClickGoShelter(View v){
        Intent intent = new Intent(DetailActivity2.this, ShelterActivity.class);
